...
class UserInterface:
    ...
    def __init__(self, app_brain: AppBrain):
        ...
        self.label_upper = customtkinter.CTkLabel(master=self.root_tk, text="Welcome to Image Watermarking",
                                                  text_font=(FONT_NAME, 16))
        self.label_upper.pack(pady=30)

        self.btn_folder = customtkinter.CTkButton(master=self.root_tk, image=self.add_folder_img, text="Add File",
                                                  width=190, height=40, compound="left", command=self.open_file)
        self.btn_folder.pack()

        self.btn_mark = customtkinter.CTkButton(master=self.root_tk, image=self.add_mark_img, text="Add Mark",
                                                width=190, height=40, compound="left", fg_color="#D35B58",
                                                hover_color="#ff3333", command=self.add_mark)
        ...
        self.entry = customtkinter.CTkEntry(self.label_frame, width=400, height=40, border_width=1,
                                            placeholder_text="Enter Text", text_color="silver")
